            ...
            <div className="p-5 gap-8 rounded-lg sm:mx-auto sm:inline-block custom-shadow border-[#4ade80] border border-opacity-20">
                <div className="flex gap-4">
                    ...
                    <div className="relative">
                        ...
                        <div className={`${openDropdownToken ? "opacity-100 -translate-y-0" : "opacity-0 -z-20 -translate-y-4"} absolute w-full z-10 bg-[hsl(240_10%_3.9%)] border rounded mt-2 border-green-600 transition-all`}>
